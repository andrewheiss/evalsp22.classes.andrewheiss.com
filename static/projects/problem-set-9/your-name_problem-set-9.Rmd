...
- Generating random numbers: <https://evalsp22.classes.andrewheiss.com/example/random-numbers/>
- The ultimate guide to generating synthetic data for causal inference: <https://evalsp22.classes.andrewheiss.com/example/synthetic-data/>
